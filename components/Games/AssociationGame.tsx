...
import { speakWord, speakGuided, speakFeedback, playUISound } from '../../services/geminiService';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
        {options.map((opt) => (
          <button
            ...
            className={`relative group bg-white p-5 rounded-[3.5rem] shadow-lg border-[10px] transition-all overflow-hidden active:scale-95 ${
              feedback === 'correct' && opt.id === currentWord.id ? 'border-green-400 scale-105' : 
